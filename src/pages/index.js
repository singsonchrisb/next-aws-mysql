...
export default function Home() {
  ...
  return (
    <>
      {" "}
      <Head>
        <title>React.Js + Next.Js, firebase & AWS MySQL Demo</title>
      </Head>
      <div className={styles.container}>
        <section className={styles.main}>
          <h1>React.Js + Next.Js, firebase & AWS MySQL Demo</h1>
          {/* <p>
          ...
          <div className={styles.heading}>
            <Link href="/productList">View Product Image List</Link>
        ...
        <footer>
        {/* <a href="/productList"> View Product Image List </a> */}
        <Link href="/productList">View Product Image List</Link>
          {/* <p>
